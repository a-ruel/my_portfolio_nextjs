  ...
  return (
    <div className="pt-4">
      <div className="w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4">
        ...
        >
         Experience Architect based on Côte D&apos;ivoire.
        </motion.h1>
        ...
        >
          Scenographer & Interior Architect | 4 years of expertise in Côte d'Ivoire. I craft immersive spaces and exceptional furniture, blending technical rigor with spatial narrative.
        </motion.p>
